...
#
# DINOv2 vision-transformer backbone. Originally from DINOv2
    ...
    def __init__(
        ...
        blocks_list = [
            block_fn(
                ...
                qk_norm=qk_norm or (i >= qknorm_start if qknorm_start >= 0 else False),
                rope=self.rope if rope_start >= 0 and i >= rope_start else None,
            )
