...
"""Tensor dataclass from Nerfstudio."""
...
class TensorDataclass:
    ...
    def cpu(self: TensorDataclassT) -> TensorDataclassT:
        """Returns a new TensorDataclass with the same data but on the CPU.

        Returns:
            A new TensorDataclass with the same data but on the CPU.
        """
        return self._apply_fn_to_fields(lambda x: x.cpu())
